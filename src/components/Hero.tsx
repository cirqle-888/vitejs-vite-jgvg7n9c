...
// 1. IMPORT THE IMAGE
// Ensure your image in 'src/assets' is named 'profile.webp'
...
export default function Hero() {
  ...
  const scrollToContact = () => {
    ...
    if (contactSection) {
      ...
      console.warn("Contact section not found. Ensure you have <section id='contact'>.");
    }
  };
        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="flex-shrink-0 relative group">
            ...
            <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden ring-2 ring-cyan-500/50">
              ...
              {/* IMAGE FIX: Using the imported variable */}
              <ImageWithFallback
                src={profileImage}
